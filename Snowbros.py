...
class Snowbros:
    ...
    def _sb_init(self):
        ...
        while counter >= 0:
            ...
            print ' >>>>>>>>>>> output the largest rect'
            self._show_rect(player_rect)
    ...
    def _get_player_move(self, f_rect, rect):
        ...
        if intr == 0:
            ...
            if self._check_move_left(f_rect, rect):
                return 'left'
            elif self._check_move_right(f_rect, rect):
                return 'right'
    ...
    def _check_move_left(self, f_rect, rect):
    ...
    def _check_move_right(self, f_rect, rect):
